...
#functions that calculator global is used to access another functions
def sub():
    firstnum=e.get()
    global fnum 
    global math 
...
#operations
buttonadded=Button(root,text="+",padx=40,pady=20,command=buttonadd)  
...
buttonadded.grid(row=4,column=1)
